...
<div class="row">
  ...
  <div class="span6">
    <div class="well well-small" id="nuget">
      The ElasticSearchTypeProvider library can be <a href="https://nuget.org/packages/ElasticSearchTypeProvider">installed from NuGet</a>:
      <pre>PM> Install-Package ElasticSearchTypeProvider</pre>
    </div>
  </div>
  <div class="span1"></div>
</div>
